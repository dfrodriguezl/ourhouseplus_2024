        ...
        {!smallScreen ?
          ...
          <Grid container>
            <Typography variant="subtitle1" className={classes.subtitle1}>
              Every time you start a new housing development, the process can be costly un-certain and unsustainable, <br />
              <span className={classes.boldText}>Until now.</span>
            </Typography>
